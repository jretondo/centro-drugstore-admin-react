...
import offButton from 'assets/img/buttons/off.png';
import onButton from 'assets/img/buttons/on.png';
...
const Ventas = ({
    ...
    const [detCustomBool, setDetCustomBool] = useState(false)
    ...
    const toggleCustom = () => setDetCustomBool(!detCustomBool)
            ...
            <CardBody>
                {
                    processing ?
                        ...
                        <>
                            ...
                            <Row>
                                <Col>
                                    <FormGroup>
                                        ...
                                        <img
                                            src={detCustomBool ? onButton : offButton}
                            ...
                            <ProdListSell
                                detCustom={detCustom}
                                setDetCustom={setDetCustom}
                                detCustomBool={detCustomBool}
                            />
                            <Row>
                                <Col md="6">
                                    <FormasPagoMod
